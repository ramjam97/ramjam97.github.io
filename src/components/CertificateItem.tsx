...
export default function CertificateItem({ item }: CertItemProps) {
    return <>
        <span className="relative">
            <span className="bg-base-200 border border-secondary absolute left-0 w-2 h-2 absolute top-5 left-0 transform translate-y-[-50%] translate-x-[-206%] rounded-full"></span>
