...
export default function CertificateItem({ item }: CertItemProps) {
    return <>
        <span className="relative">
            <span className="bg-base-200 border border-info absolute left-0 w-2 h-2 absolute top-3 left-0 transform translate-y-[-50%] translate-x-[-250%] rounded-full"></span>
